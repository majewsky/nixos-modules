...
in {
  ...
  config = mkIf (cfg.domainName != null) {
    ...
    security.acme.certs.${cfg.domainName}.postRun = "systemctl restart prosody-early.service prosody.service";
    ...
    systemd.services.prosody-early = {
      description = "setup TLS certs for prosody.service";
    ...
    systemd.services.prosody = {
      requires = [ "prosody-early.service" ];
      after = [ "prosody-early.service" ];
    };
